...
function showGameOver() {
    ...
    document.getElementById('extraMenuButtons').style.display = 'none';
    overlay.innerHTML = `
 <h2>GAME OVER</h2><div class="bigscore">PUNTOS: ${Math.floor(score)}</div><div style="font-size:12px; margin:6px 0; color: #aaa;">Modo: ${DIFFICULTY_CONFIG[difficulty].label}</div><div style="font-size:16px; margin:10px 0;">Monedas ganadas: ${sessionCoins}</div><div class="menu-buttons"><button class="menu-btn" onclick="startRun()">JUGAR DE NUEVO</button><button class="menu-btn" onclick="returnToMenu()">MENÚ PRINCIPAL</button></div>
 `;
}
...
function returnToMenu() {
    ...
    overlay.innerHTML = `
 <img src="assets/logo_capi.png" class="logo" alt="Capibara Logo" onerror="this.style.display='none'"><h2>CAPI RUN</h2><div class="menu-buttons"><button id="startBtn" class="menu-btn" onclick="startGame()">START GAME</button><button class="menu-btn" onclick="openModal('storeModal')">STORE</button><button class="menu-btn" onclick="openModal('leaderboardModal')">LEADERBOARD</button><button class="menu-btn" onclick="openModal('authModal')">SETTINGS</button></div>
 `;
}
